...
**Ordine**: ✅ **v0.5.0 SHIPPED** (`v0.5.0`, `e0ab544`) — onboarding (F-40/41/42) + wake (F-36) + 3 leve fluidità (F-48/F-43/F-34). **Backlog minore → v0.5.1** (su `feat/v0.5-fluidity`, NON ancora taggato): F-49 ✅ `--unseen` (`5fc1675`) + **F-37 ✅** in-reply-to existence (`da3598f`) + fix F-49 precedence (`d5a5f82`) → **le reti-di-sicurezza anti-allucinazione LL-13 (F-43 dedup + F-34 unread + F-37 existence) COMPLETE**. Prossimi: **F-39** riferimenti simbolici · **F-23b** read-receipt · **F-50** anti-sordità (hook harness, non-bridge) · F-45/F-44/F-46/F-11 + chore gofmt.
