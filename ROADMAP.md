...
**Ordine**: ✅ **v0.5.0 SHIPPED** (`v0.5.0`, `e0ab544`) — onboarding (F-40/41/42) + wake (F-36) + 3 leve fluidità (F-48 read · F-43 dedup · F-34 incroci). **Backlog minore → v0.5.1** (su `feat/v0.5-fluidity`, NON ancora taggato): F-49 ✅ (`5fc1675`); prossimi **F-50** anti-sordità · **F-37** msg-id validation (riusa `message.ValidateMessageID`) · **F-39** riferimenti simbolici · F-23b · F-45/F-44/F-46/F-11 + chore gofmt.
