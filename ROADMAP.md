...
**Ordine v0.5**: F-40+F-41+F-42 ✅ + F-36 ✅ + F-48 ✅ + F-43 ✅ + **F-34 ✅ DONE+MERGED** (`55caf42`; warning pre-`ask` anti-incroci) → **le 3 leve TOP v0.5 (F-48 read · F-43 dedup · F-34 incroci) COMPLETE** + onboarding (F-40/41/42) + wake (F-36). **PROSSIMO: tag `v0.5.0`** (CHANGELOG + `install-plugin` + GitHub Release). Backlog minore residuo (post-v0.5.0): F-49 receive --unseen, F-50 anti-sordità, F-23b read-receipt, F-45/F-39/F-37/F-47/F-44/F-46/F-11.
